...
class PlasmicAction {
    ...
    sync() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const path = (_a = this.args.localizedStrings) === null || _a === void 0 ? void 0 : _a.replace(/[^\d\w\/_.-]/, "");
            if (path) {
                yield exec_1.exec(`rm -f ${path}`, this.opts);
                yield exec_1.exec(`${pm.cmd} plasmic localization-strings --format po -o ${path} --projects '${this.args.projectId}' --yes`, this.opts);
