        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (platform) {
                case "nextjs":
                    ...
                    const nextOpts = Object.assign(Object.assign({}, this.opts), { env: Object.assign(Object.assign({}, this.opts.env), { STATIC_EXPORT: "true" }) });
                    yield exec_1.exec(`${pm.cmd} next build`, nextOpts);
                    yield exec_1.exec(`${pm.cmd} next export`, nextOpts);
                    dir = "out";
                    break;
                case "gatsby":
