...
class PlasmicAction {
    ...
    sync() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localizationStringsPath = (_a = this.args.localizationStringsPath) === null || _a === void 0 ? void 0 : _a.match(/^[\w\d\/._-]+\.([\w]+)$/);
            if (localizationStringsPath) {
                const [path, format = this.args.localizationStringsFormat,] = localizationStringsPath;
                yield exec_1.exec(`rm -f ${path}`, this.opts);
                yield exec_1.exec(`${pm.cmd} plasmic localization-strings --format ${format} -o ${path} --projects '${this.args.projectId}' --yes`, this.opts);
