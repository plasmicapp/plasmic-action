 ...
 * @returns
 */
export declare function writeDefaultNextjsConfig(projectDir: string, projectId: string, loader: boolean): Promise<void>;
 ...
 * @returns
 */
export declare function modifyDefaultGatsbyConfig(projectDir: string, projectId: string): Promise<void>;
/**
