...
function create(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (scheme === "codegen") {
            ...
            yield spawnOrFail(`npx -p @plasmicapp/cli plasmic sync --yes -p ${project}`, resolvedProjectPath);
        }
        else if (scheme === "loader") {
            if (platform === "nextjs") {
                yield file_utils_1.writeDefaultNextjsConfig(resolvedProjectPath, projectId, true);
            }
            else if (platform === "gatsby") {
