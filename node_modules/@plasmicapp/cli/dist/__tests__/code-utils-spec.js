...
export const CodeSandboxDialogContent = observer(
    ...
    >
        ...
        expect(code_utils_1.formatScript(code_utils_1.tsxToJsx(code)).trim()).toEqual(`
// This is a skeleton starter React component generated by Plasmic.
// @jsx helper
...
`;
        ...
        const replaced = code_utils_1.replaceImports(context, code, "/tmp/CodeSandbox.tsx", fixImportContext, false);
...
`;
        ...
        const replaced = code_utils_1.replaceImports(context, code, "/tmp/CodeSandbox.tsx", fixImportContext, true);
        const expectedCode = `// This is a skeleton starter React component generated by Plasmic.
import React, { ReactNode } from "react";
import {
  PlasmicCodeSandboxDialogContent__RenderHelper,
...
*/
`;
        expect(code_utils_1.formatScript(input)).toEqual(`import React, { ReactNode } from "react";
import "@plasmicapp/react-web/lib/plasmic.css";
