...
function syncGlobalVariants(context, projectMeta, bundles, checksums) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const bundle of bundles) {
            ...
            yield file_utils_1.writeFileContent(context, variantConfig.contextFilePath, code_utils_1.formatAsLocal(bundle.contextModule, variantConfig.contextFilePath), { force: !isNew });
        }
