...
function initPlasmic(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const configFile = opts.config || config_utils_1.findConfigFile(process.cwd(), { traverseParents: false });
        ...
        const newConfigFile = opts.config || upath_1.default.join(process.cwd(), config_utils_1.CONFIG_FILE_NAME);
        const answers = yield deriveInitAnswers(opts);
        yield config_utils_1.writeConfig(newConfigFile, createInitConfig(answers));
        ...
        if (answer) {
            npm_utils_1.installUpgrade("@plasmicapp/react-web");
        }
    });
}
...
function deriveInitAnswers(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        const plasmicRootDir = opts.config
            ? upath_1.default.dirname(opts.config)
            : process.cwd();
