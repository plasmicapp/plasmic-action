...
function syncProjectComponents(context, project, version, componentBundles, forceOverwrite, appendJsxOnMissingBase, summary, pendingMerge, projectLock, checksums) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const bundle of componentBundles) {
            const { renderModule, skeletonModule, cssRules, renderModuleFileName, skeletonModuleFileName, cssFileName, componentName, id, scheme, nameInIdToUuid, isPage, } = bundle;
            ...
            const formattedCssRules = code_utils_1.formatAsLocal(cssRules, compConfig.cssFilePath);
