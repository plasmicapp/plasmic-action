...
function syncProjectIconAssets(context, projectId, version, iconBundles, checksums) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const bundle of iconBundles) {
            ...
            yield file_utils_1.writeFileContent(context, iconConfig.moduleFilePath, code_utils_1.formatAsLocal(bundle.module, iconConfig.moduleFilePath), {
                force: !isNew,
            });
        }
