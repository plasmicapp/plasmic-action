...
function getContext(args, { enableSkipAuth = false } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        /** PlasmicConfig **/
        let configFile = args.config || config_utils_1.findConfigFile(process.cwd(), { traverseParents: true });
        if (!configFile) {
            yield maybeRunPlasmicInit(args, "plasmic.json", enableSkipAuth);
            configFile = config_utils_1.findConfigFile(process.cwd(), { traverseParents: true });
            if (!configFile) {
        ...
        yield migrations_1.runNecessaryMigrations(configFile, lockFile, args.yes);
