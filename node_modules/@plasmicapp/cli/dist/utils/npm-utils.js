...
exports.detectPackageManager = exports.installCommand = exports.installUpgrade = exports.findPackageJsonDir = exports.isCliGloballyInstalled = exports.findInstalledVersion = exports.warnLatest = exports.getParsedPackageJson = exports.getCliVersion = exports.getParsedCliPackageJson = void 0;
...
function warnLatest(context, pkg, msgs, yes) {
...
function detectPackageManager() {
    const yarnLock = findup_sync_1.default("yarn.lock", { cwd: process.cwd() });
    if (yarnLock) {
        return "yarn";
    }
    else {
