...
class PlasmicApi {
    ...
    genStyleConfig(styleOpts) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post(`${this.auth.host}/api/v1/code/style-config`, styleOpts);
            return result.data;
        });
    }
    /**
    ...
    resolveSync(projects, recursive) {
        return __awaiter(this, void 0, void 0, function* () {
            const resp = yield this.post(`${this.auth.host}/api/v1/code/resolve-sync`, {
                projects,
                recursive,
            });
    ...
    getCurrentUser() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get(`${this.auth.host}/api/v1/auth/self`, {
    ...
    requiredPackages() {
        return __awaiter(this, void 0, void 0, function* () {
            const resp = yield this.post(`${this.auth.host}/api/v1/code/required-packages`);
     ...
     * @param version
     */
    projectComponents(projectId, platform, newCompScheme, 
    // The list of existing components as [componentUuid, codeScheme]
    existingCompScheme, componentIdOrNames, version, imageOpts, stylesOpts, checksums, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post(`${this.auth.host}/api/v1/projects/${projectId}/code/components`, {
                platform,
                newCompScheme,
                existingCompScheme,
                componentIdOrNames,
    ...
    uploadBundle(projectId, bundleName, bundleJs, css, metaJson, genModulePath, genCssPaths, pkgVersion, extraPropMetaJson, themeProviderWrapper, themeModule) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post(`${this.auth.host}/api/v1/projects/${projectId}/jsbundle/upload`, {
                projectId,
                bundleName,
                bundleJs,
                css,
    ...
    projectStyleTokens(projectId, versionRange) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post(`${this.auth.host}/api/v1/projects/${projectId}/code/tokens`, { versionRange });
            return result.data;
        });
    }
    projectIcons(projectId, versionRange, iconIds) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post(`${this.auth.host}/api/v1/projects/${projectId}/code/icons`, { versionRange, iconIds });
            return result.data;
        });
    }
    projectSyncMetadata(projectId, revision, rethrowAppError) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post(`${this.auth.host}/api/v1/projects/${projectId}/code/project-sync-metadata`, { revision }, rethrowAppError);
            return code_merger_1.ProjectSyncMetadataModel.fromJson(result.data);
        });
    }
    connectSocket() {
        const socket = socket_io_client_1.default.connect(this.auth.host, {
            path: `/api/v1/socket`,
            transportOptions: {
                polling: {
