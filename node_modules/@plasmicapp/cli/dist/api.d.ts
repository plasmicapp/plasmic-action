...
export declare class PlasmicApi {
     ...
     * @param version
     */
    projectComponents(projectId: string, platform: string, newCompScheme: "blackbox" | "direct", existingCompScheme: Array<[string, "blackbox" | "direct"]>, componentIdOrNames: readonly string[] | undefined, version: string, imageOpts: ImagesConfig, stylesOpts: StyleConfig, checksums: ChecksumBundle, metadata?: Metadata): Promise<ProjectBundle>;
