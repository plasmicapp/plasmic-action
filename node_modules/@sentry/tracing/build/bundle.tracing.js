...
var Sentry = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var getNavigationEntryFromPerformanceTiming = function () {
        ...
        // eslint-disable-next-line deprecation/deprecation
        var timing = global$5.performance.timing;
        var navigationEntry = {
    ...
    var getTTFB = function (onReport) {
        ...
        afterLoad(function () {
            try {
                ...
                var navigationEntry = global$5.performance.getEntriesByType('navigation')[0] || getNavigationEntryFromPerformanceTiming();
    ...
    var MetricsInstrumentation = /** @class */ (function () {
        ...
        MetricsInstrumentation.prototype._trackNavigator = function (transaction) {
            var navigator = global$6.navigator;
            if (!navigator) {
                return;
            }
    ...
    function instrumentRoutingWithDefaults(customStartTransaction, startTransactionOnPageLoad, startTransactionOnLocationChange) {
        ...
        if (startTransactionOnPageLoad) {
            activeTransaction = customStartTransaction({ name: global$7.location.pathname, op: 'pageload' });
        }
            ...
            addInstrumentationHandler({
                callback: function (_a) {
                    ...
                    if (from !== to) {
                        ...
                        activeTransaction = customStartTransaction({ name: global$7.location.pathname, op: 'navigation' });
                    }
                },
                type: 'history',
            });
